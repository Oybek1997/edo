            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '10.142.62.247')),
                // 'hosts' => explode(' ', env('LDAP_HOSTS', '10.142.62.246')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'DC=AD,DC=UZAUTOMOTORS,DC=COM'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'bitrix_sync'),
                'password' => env('LDAP_PASSWORD', 'Bs123456789'),
