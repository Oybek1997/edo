...
if ($response->success == '1') {
                    ...
                    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
                        ...
                        <tr>
                                <td style="width: 50%" colspan="4">
                                    ...
                                    <b><?php //$arrResponse->header->department->value ?></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 50%" colspan="4">
    ...
    foreach ($arrResponse->income_benefits as $obj) {
    ...
    $length = ($length_accrued > $length_paid) ? $length_accrued : $length_paid;
    ...
    for ($i = 1; $i < $length - 1; $i++) {
        ?>
                                    <tr>
                                            ...
                                            <td><?=isset($arr_paid[$i]) && $length_paid-1 != $i ? $arr_paid[$i]->label : ''?></td>
                            ...
                            <tr>
                                ...
                                <th style="text-align: left;padding-left: 5px"><?=$arr_paid[$length_paid-1]->label?></th>
                                <th style="text-align: right;padding-right: 5px"><?=$arr_paid[$length_paid-1]->value?></th>
                            </tr>
                            <tr>
    ...
    $length = ($length_to_issue > $length_withheld) ? $length_to_issue : $length_withheld;

    for ($i = 1; $i < $length - 1; $i++) {
        ?>
                                    <tr>
                                            <td><?=isset($arr_withheld[$i]) ? $arr_withheld[$i]->label : ''?></td>
                            ...
                            <tr>
                                <th style="text-align: left;padding-left: 5px"><?=$arr_withheld[$length_withheld-1]->label ? $arr_withheld[$length_withheld-1]->label : ''?></th>
                                <th style="text-align: right;padding-right: 5px"><?=$arr_withheld[$length_withheld-1]->value ? $arr_withheld[$length_withheld-1]->value : ''?></th>
