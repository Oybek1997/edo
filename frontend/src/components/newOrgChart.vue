    ...
    renderChart(data) {
      ...
      this.chartReference
        ...
        .nodeContent(function (d, i, arr, state) {
          ...
          return `
          <div style="font-family: 'Inter', sans-serif;background-color:${color}; position:absolute;margin-top:-1px; margin-left:-1px;width:${d.width}px;height:${d.height}-10px;">
            ...
            <table style="border-collapse: collapse; font-size: 9px; width: 100%; ">
              <thead>
                <tr>
                  ...
                  <td colspan="5" style="max-width:20px; padding: 2px; border: 1px solid black; white-space: wrap; text-align:center;">${d.data.name}</td>
                </tr>
                <tr>
                  <td colspan="2" style="white-space: wrap; padding: 2px; border: 1px solid black; text-align:center;">${d.data.position}</td>
                  <td style="border: 1px solid black; padding: 2px; ">${range }</td>
                  <td style="border: 1px solid black; padding: 2px; ">TM</td>
                  <td style="border: 1px solid black; padding: 2px; ">HC</td>
                </tr>
                <tr>
                  <td style="border: 1px solid black; padding: 2px;">${d.data.tabel}</td>
                  <td style="white-space: wrap; padding: 2px; border: 1px solid black; text-align:center;">${d.data.manager}</td>
                  <td style="border: 1px solid black; padding: 2px;">${tarif}</td>
                  <td style="border: 1px solid black; padding: 2px;">${d.data._directSubordinates}</td>
                  <td style="border: 1px solid black; padding: 2px;">${head_count}</td>
                </tr>
              </thead>
              </table>
