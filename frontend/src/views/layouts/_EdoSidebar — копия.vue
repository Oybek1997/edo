        ...
        >
          ...
          <v-list class="py-0 list-group list-group_child" flat>
            <v-list-item-group v-model="item.model" color="indigo">
              <v-list-item
                v-for="(itema, indexs) in item.list.filter(
                  (v) => v.permission && v.visible
                )"
                :key="indexs"
                :to="itema.route"
                color="blue"
...
export default {
          ...
          list: [
            {
              ...
              visible: true,
              permission: this.$store.getters.checkPermission("centrum"),
            },
            {
              icon: "mdi-archive-outline",
      ...
      this.items = [
        {
          ...
          list: [
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("База данных сотрудников(Xodim)"),
            ...
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Уволенные сотрудники(Ishdan ketgan hodimlar)"),
            ...
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ishdan bo'shatilish sabablari"),
              route: "/personcontrol/leaving-reasons/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Shikoyat mazmuni"),
              route: "/personcontrol/appeal-content/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ta'til buyrug' reestri"),
              route: "/personcontrol/vacation-registry",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ish rejimi reestri"),
              route: "/personcontrol/ish-rejimi-registry",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Otgul buyrug' reestri"),
              route: "/personcontrol/otgul-registry",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("O'quv ta'til reyestri"),
              route: "/personcontrol/education-registry",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("H.safari buyrug' reestri"),
              route: "/personcontrol/business-trip-registry",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ish kalendari"),
              route: "/personcontrol/work-calendar",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Oilaviy qarindoshlar"),
              route: "/personcontrol/family-relative/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              ...
              route: "/personcontrol/hr-language/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Partiya"),
              route: "/personcontrol/hr-party/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ta'lim darajasi"),
              route: "/personcontrol/hr-study-degree/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ta'lim turlari"),
              route: "/personcontrol/hr-study-type/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Oliy o'quv yurti"),
              route: "/personcontrol/hr-university/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Ma'lumoti bo'yicha mutaxassisligi"),
              route: "/personcontrol/hr-major/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Harbiy unvon"),
              route: "/personcontrol/hr-military-rank/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-file-plus-outline",
              text: this.$t("Davlat mukofotlari"),
              route: "/personcontrol/hr-state-awards/list",
              color: "#00B950",
              visible: true,
              permission: true,
            },
        ...
        },
        {
          ...
          list: [
            ...
            },
            {
              ...
              color: "#F8A300",
              visible: true,
              permission: this.$store.getters.checkPermission("shtat-korish"),
            },
            {
              icon: "mdi-card-account-details-outline x-small",
            ...
            },
            {
              ...
              visible: true,
              permission: this.$store.getters.checkPermission("critical-index"),
            },

            {
              ...
              color: "#F8A300",
              visible: true,
              permission: this.$store.getters.checkPermission("department-index"),
            },
            {
              ...
              color: "#F8A300",
              visible: true,
              permission: this.$store.getters.checkPermission(
            ...
            },
            {
              ...
              route: "/personcontrol/working-on7",
              color: "#F8A300",
              visible: true,
              permission: true,
            },
          ...
          list: [
            {
              ...
              route: "/personcontrol/working-on6",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
            {
              ...
              route: "/personcontrol/working-on5",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
            {
              ...
              route: "/personcontrol/working-on4",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
            {
              icon: "mdi-none",
              text: this.$t("Другие настройки"),
              route: "/personcontrol/working-on3",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
          ...
          list: [
            {
              icon: "mdi-none",
              text: this.$t("Подбор персонала"),
              route: "/personcontrol/working-on2",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
          ...
          list: [
            {
              icon: "mdi-none",
              text: this.$t("Подбор персонала"),
              route: "/personcontrol/working-on1",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
          ...
          list: [
            {
              icon: "mdi-none",
              text: this.$t("Подбор персонала"),
              route: "/personcontrol/working-on",
              color: "#4CAF50",
              visible: true,
              permission: true,
            },
  ...
  mounted() {
    // console.log('sidebar',localStorage.getItem('modules'));
    this.getList();
  },
};
</script>
