<template>
  <v-app style="background-color: #eef0f7" class="overflow-y-auto">
    <v-app-bar app color="#fffeff" class="elevation-0">
      ...
      >
        ...
        <v-card v-if="idesDocList">
          ...
          <v-list class="py-0" style="cursor: pointer" dense>
            <v-list-item to="/ides/index/pending">
      ...
      >
        <template v-slot:activator="{ on }">
          <v-btn text small v-on="on" class="ml-1" :title="$t('for_info')">
            <v-badge
              color="grey darken-2"
      ...
      >
        <template v-slot:activator="{ on }">
          <v-btn text small v-on="on" :title="$t('pending')">
            <v-badge
      ...
      <template>
        ...
        <v-card class="mx-auto elevation-0" max-width="300" tile>
          ...
          <v-list dense subheader class="left-aside">
            ...
            <!-- ONly Administrators My Documents -->
            <v-list-group v-if="$store.getters.checkRole('superadministrator')">
              <template v-slot:activator>
                <v-list-item-icon class="mr-1">
                  <v-icon>mdi-file-document-outline</v-icon>
                </v-list-item-icon>
            ...
            <!-- END ONly Administrators My Documents -->
            ...
            >
              ...
              <template>
                <v-list-item
                  v-if="
                    $store.getters.checkPermission('complaens-cancel-documents')
                  "
                  router
                ...
                >
                  ...
                  <v-list-item-content>
                    <v-list-item-title v-text="$t('cancel_documents')"></v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </template>
              <template>
                <v-list-item
                  ...
                  "
                  router
                  to="/complaens/control/payment_sheet"
                  class="pl-4"
                  :title="$t('report.payment_sheet')"
                >
                  <v-list-item-icon class="mr-1" :title="$t('report.payment_sheet')">
                    <v-icon small>mdi-file-document-outline</v-icon>
                  </v-list-item-icon>

                  <v-list-item-content>
                    <v-list-item-title v-text="$t('report.payment_sheet')"></v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </template>
              <template>
                <v-list-item
                  ...
                  "
                  router
                  to="/complaens/control/lsp"
                  class="pl-4"
                  :title="$t('report.lsp')"
                >
                  <v-list-item-icon class="mr-1" :title="$t('report.lsp')">
                    <v-icon small>mdi-file-document-outline</v-icon>
                  </v-list-item-icon>

                  <v-list-item-content>
                    <v-list-item-title v-text="$t('report.lsp')"></v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </template>
            </v-list-group>-->
            ...
            <v-list-group v-if="$store.getters.checkPermission('ides')">
              ...
              >
                ...
                <v-badge
                  class="mr-2 mt-3"
                  color="green darken-1"
                  v-if="idesDocCount && idesDocCount != 0"
