<template>
  <v-app id="inspire">
    <v-app-bar
      app
      style="background: radial-gradient(circle, rgb(0 113 209) 0%, rgb(93 1 136) 100%);"
      dark
    >
      <v-app-bar-nav-icon @click.stop="drawer = !drawer" />
      <v-toolbar-title>CDPT Kadirlar boshqaruvi</v-toolbar-title>
      <v-spacer></v-spacer>
    ...
    <v-navigation-drawer v-model="drawer" app>
      <template>
        <v-card class="mx-auto" max-width="300" tile>
          <v-app-bar dark style="background: rgb(67 0 98);">
    ...
    links() {
      return [
        ...
        },
        {
          ...
          route: "/cdpt/competence-types",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("cdpt.specific_skills"),
          route: "/cdpt/specific-skills/1",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("Funktsional bilimlar"),
          route: "/cdpt/specific-skills/2",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("Yetakchilik"),
          route: "/cdpt/specific-skills/3",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("cdpt.department_type"),
          route: "/cdpt/department-types",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("cdpt.priority_field"),
          route: "/cdpt/priority-fields",
          visible: true
        },
        {
          icon: "mdi-briefcase-account-outline",
          text: this.$t("cdpt.career_development_plan"),
          route: "/cdpt/career-development-plans",
          visible: true
        }
      ];
    }
