        ...
        <template v-slot:default>
          ...
          <tbody v-for="(item, key) in items" :key="key">
            ...
            >
              ...
              >
                {{
                  item.employee.main_staff && item.employee.main_staff.length > 0
              ...
              >
                ...
                >
                  {{
                    detail_employee.employee ? detail_employee.employee.tabel : ''
              ...
              >
                ...
                >
                  {{
                    detail_employee.employee ? detail_employee.employee.lastname_uz_latin : ''
                    
                  }} {{detail_employee.employee ? detail_employee.employee.firstname_uz_latin : ''}}
                  <br />
                </span>
              </td>
              <td
              ...
              >
                ...
                >
                  {{
                    detail_employee.employee ? detail_employee.employee_position : ''
              ...
              >
                ...
                >
                  {{
                    detail_employee.employee ? detail_employee.employee_department_code : ''
              ...
              >
                ...
                >
                  {{
                    detail_employee.employee ? detail_employee.employee_department : ''
...
export default {
  ...
  methods: {
    makeDocument() {
      ...
      axios
        .post(this.$store.state.backend_url + "api/tabel-registry-create", {
          ids: ids,
    ...
    getList() {
      ...
      this.loading = this.loading + 1;
      axios
        .get(this.$store.state.backend_url + "api/tabel-registry/" + locale)
        .then((response) => {
