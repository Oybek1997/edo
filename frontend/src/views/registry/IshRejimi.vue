        ...
        <template v-slot:default>
          <thead>
            <tr>
              ...
              <th style="background-color: #f0f0f5">Sana boshlanishi</th>
              <th style="background-color: #f0f0f5">Sana tugashi</th>
              <th style="background-color: #f0f0f5">Belgilangan ish soati</th>
              <th style="background-color: #f0f0f5">Belgilangan ish soati</th>
          ...
          <tbody v-for="(item, key) in items" :key="key">
            ...
            >
              ...
              <td>
                {{ detail.document_detail_contents[0].value }}
              </td>
              <td>
                {{ detail.document_detail_contents[2].value }}
              </td>
              <td>
                {{ detail.document_detail_contents[1].value }}
              </td>
              <td>
                {{ detail.document_detail_contents[3].value }}
              </td>
              <td>
                {{ detail.document_detail_contents[4].value }}
              </td>
              <td
                width="40"
                :rowspan="detail_key == 0 ? item.document_details.length : 1"
...
export default {
  ...
  methods: {
    makeDocument() {
      ...
      axios
        .post(this.$store.state.backend_url + "api/ish-rejimi-registry-create", {
          ids: ids,
    ...
    getList() {
      ...
      axios
        .get(
          this.$store.state.backend_url + "api/ish-rejimi-registry/" + locale
        )
        .then((response) => {
