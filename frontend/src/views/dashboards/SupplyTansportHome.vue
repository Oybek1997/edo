<template>
    <div class="fullHeight">
            ...
            <v-card class="d-flex align-content-start justify-space-between" flat tile>
              <v-hover>
                <template v-slot="{ hover }">
                  ...
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Ehtiyot qismilari") }}</v-card-title>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Trasnport vositalari") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                      23
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Transport vositalari") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                     23
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Ta'mirlovchi birgadirlar") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                      8
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Avto-yuklagich haydovchilar") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                      66
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Nosoz texnikalar") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                      14
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
              ...
              <v-hover>
                <template v-slot="{ hover }">
                  <v-card
                    ...
                    style="border-radius: 5px; background: #FBFCFE; border: 1px solid #fff; box-shadow: 0px 0px 3px 1px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12)!important"
                  >
                    <v-card-title class="card_title pa-3">{{ $t("Ta'mirlash ehtiyot qismlari") }}</v-card-title>
                    <v-card-title class="card_title-number px-3 pt-0 pb-3">
                      123
                    </v-card-title>
                    <v-divider class="mx-3" color="#DCE5EF"></v-divider>
      ...
      <!-- Singli date qismi boshlandi -->
      <div class="text-center">
    </div>
      <!-- Singli date qismi tugadi -->
    </div>
  </template>
