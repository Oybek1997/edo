      ...
      <v-card-text>
        ...
        >
          ...
          <template v-slot:item.document_number="{ item }">
            <v-tab
              class="hover"
              :to="'/document/' + item.documents.pdf_file_name"
            >
              {{
                item.documents.document_number_reg
                  ? item.documents.document_number_reg
                  : item.documents.document_number
              }}
            </v-tab>
          </template>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      axios
        // .post(this.$store.state.backend_url + "api/okd-report-item-full", {
        .post(this.$store.state.backend_url + "api/report-item-full" , {
