  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("staff.staff") }}</span>
          ...
          >
            ...
            <template v-slot:item="{ item, index }">
              <tr>
                ...
                <td style="max-width: 70px" :style="item.is_active == 0 ? 'color:red;' : 'color:blue;'">
                  {{
                    item.is_active == 0
                      ? $t("employee.inactive")
                      : $t("employee.active")
                ...
                <td style="max-width: 150px">
                  ...
                  <v-btn
                    v-if="$store.getters.checkPermission('shtat-ochirish')"
                    class="pl-0 pr-2"
                    color="red"
                    style="min-width: 25px"
                    small
                  ...
                  >
                    <v-icon size="18">
                      {{ item.is_active ? "mdi-trash-can-outline" : "mdi-restore" }}
                    </v-icon>
                  </v-btn>
                  <v-btn
    ...
    <v-card class="mt-1 pa-3" style="border-radius: 1px">
        ...
        <v-card-text>
          <v-form @keyup.native.enter="save" ref="dialogForm" class="ma-0">
            <v-row class="mx-0 dialog-form" >
              <v-col cols="12">
                <v-autocomplete
                  clearable
                  v-model="form.department_id"
                  :items="departmentList"
                  :label="$t('staff.department_id')"
              ...
              <v-col cols="6">
                <v-autocomplete
                  clearable
                  :label="$t('staff.personal_type_id')"
    ...
    <v-card class="mt-1 pa-3" style="border-radius: 1px">
        ...
        <v-card-text>
          <v-form @keyup.native.enter="save" ref="dialogForm" class="ma-0">
            <v-row class="dialog-form">
              <v-col cols="4" md="4" class="mb-0 pa-2">
                <v-text-field
              ...
              <v-col cols="4" md="4" class="mb-0 pa-2" v-if="criticalForm.isNew == false">
        ...
        <v-card-actions>
          ...
          <v-btn
            ...
            dark
            elevation="0"
            @click="dialogStaffCritical = false"
            style="text-transform: none; border-radius: 5px; padding: 5px 20px"
          >
            {{ $t("Отменить") }}
          </v-btn>
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        {
          text: this.$t("staff.department_id"),
          value: "department_name",
        },
        {
          text: this.$t("staff.position_id"),
          value: "position_name",
        },
