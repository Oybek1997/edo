  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("Bo'linmalar") }}</span>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      axios
        .post(
          this.$store.state.backend_url + "api/supplytransports/all-sections",
          {
    ...
    newItem() {
      this.dialogHeaderText = "Smena qo'shish";
      this.form = {
        name: "",
      };
      this.dialog = true;
    ...
    save() {
      axios
        .post(
          this.$store.state.backend_url + "api/saveupdate/supplysection",
          this.form
        )
        .then((res) => {
          this.getList();
