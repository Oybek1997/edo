              ...
              <v-list class="dropdown-list pa-0">
                ...
                >
                  <v-list-item-title>
                    ...
                    {{ $t("Yangi ta’mirlovchi chilangar qo'shish") }}
...
export default {
  ...
  methods: {
      ...
      axios
        .post(
          this.$store.state.backend_url +
            "api/supplytransports/all-repairplumbers",
          {
    ...
    newItem() {
      this.dialogHeaderText = "Ta’mirlovchi chilangar qo'shish";
      this.form = {
        name: "",
      };
      this.dialog = true;
