  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("Ehtiyot qismlari") }}</span>
        ...
        <v-card-text>
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              ...
              <v-col cols="12" md="12" class="mb-2 pa-0">
                <v-text-field
                  v-model="form.standard_indicator"
                  label="Me’yor ko‘rsatkichi"
                  hide-details="auto"
                  dense
                  outlined
                ></v-text-field>
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        {
          text: this.$t("Me'yor ko'rsatkichi"),
          value: "standard_indicator",
          align: "center",
          class: "grey lighten-3",
          sortable: false,
          tabList: true,
        ...
        {
          text: this.$t("Oy(taxminiy)"),
          value: "estimated_month",
          align: "center",
          class: "grey lighten-3",
          sortable: false,
          tabList: true,
  ...
  methods: {
    ...
    getList() {
      ...
      axios
        .post(
          this.$store.state.backend_url + "api/supplytransports/all-spareparts",
          {
    ...
    save() {
      axios
        .post(
          this.$store.state.backend_url + "api/saveupdate/sparepart",
          this.form
        )
        .then((res) => {
          this.getList();
    ...
    deleteItem(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete(
              this.$store.state.backend_url + "api/delete/sparepart/" + item.id
            )
            .then((res) => {
