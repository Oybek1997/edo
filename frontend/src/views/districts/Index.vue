  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("districts.index") }}</span>
          ...
          >
            ...
            <v-card>
              <v-list class="dropdown-list pa-0">
                <v-list-item
                  v-if="$store.getters.checkPermission('district-create')"
        ...
        <v-col class="ma-0 pa-0" xs="12">
          ...
          >
            ...
            <template v-slot:item.actions="{ item }">
              <v-btn
                v-if="$store.getters.checkPermission('district-update')"
                class="px-0"
                color="blue"
              ...
              <v-btn
                v-if="$store.getters.checkPermission('district-delete')"
                class="pl-0 pr-2"
                color="error"
                style="min-width: 25px"
                small
    ...
    >
      <v-card class="pa-5">
        <v-card-title class="pa-0" primary-title>
          <span class="dialogTitle">{{ $t("districts.dialogHeaderText") }}</span>
        </v-card-title>
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" sm="6" class="px-1 py-0 mb-3">
                <label class="labelTitle" for>{{ $t("regions.region_id") }}</label>
                <v-autocomplete
                  clearable
