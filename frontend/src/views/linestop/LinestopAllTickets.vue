  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("linestop.all_tickets") }}</span>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/linestop/alltickets", {
    ...
    getListExcel() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/linestop/allticketsexcel")
        .then((response) => {
