  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("linestop.my_stops") }}</span>
  ...
  methods: {
    ...
    getList() {
      ...
      axios
        ...
        .then((response) => {
          this.items = response.data.mylinestops.data;
          this.server_items_length = response.data.mylinestops.total;
          console.log(this.server_items_length);
          this.loading = false;
        })
        .catch((error) => {
          console.log(error);
    ...
    getListExcel() {
      console.log("Excel olish");
      // this.loading = true;
      // axios
      //   .post(
      //     this.$store.state.backend_url + "api/linestop/allautobotticketsexcel"
      //   )
      //   .then((response) => {
