  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("linestop.line") }}</span>
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: "linestop.line", class: "blue-grey lighten-5", value: "line" },
        {
          text: "linestop.comment",
          class: "blue-grey lighten-5",
          value: "comment",
        },
        {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/get/all-lines", {
    ...
    getListShops() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/get/all-shops")
        .then((response) => {
    ...
    newItem() {
      this.dialogHeaderText = "linestop.add_line";
      this.form = {
        name: "",
      };
      this.dialog = true;
    ...
    save() {
      axios
        .post(this.$store.state.backend_url + "api/saveupdate/line", this.form)
        .then((res) => {
          this.getList();
          this.dialog = false;
    ...
    deleteItem(item) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete(
              this.$store.state.backend_url + "api/delete/line/" + item.id
            )
            .then((res) => {
