  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('linestop.shops') }}</span>
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('linestop.shop_name') }}</label>
                <v-text-field
                  v-model="form.name"
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('linestop.shop_comment') }}</label>
                <v-text-field
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
      {
        ...
        { text: "linestop.shop_name", class: "blue-grey lighten-5", value: "name" },
        {
          text: "linestop.shop_comment",
          class: "blue-grey lighten-5",
          value: "comment",
        },
        {
  ...
  methods: {
    ...
    newItem() {
        this.dialogHeaderText = "linestop.add_shop";
        this.form = {
          name: "",
        };
        this.dialog = true;
    ...
    save() {
        axios
          .post(
            this.$store.state.backend_url + "api/saveupdate/shop",
            this.form
          )
          .then(res => {
            this.getList();
