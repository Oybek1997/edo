    ...
    >
      ...
      <v-card-title class="px-5 py-2">
        ...
        <v-btn
          ...
          right
          x-small
          v-if="ticket.status == 2 && isUserTicketOwner"
          outlined
          dark
          elevation="0"
          style="text-transform: none; border-radius: 5px; padding: 5px 20px"
        ...
        <v-btn
          ...
          right
          x-small
          v-if="ticket.status == 1 && isUserTicketOwner"
          outlined
          v-show="ticket.status != 3"
          dark
          elevation="0"
          style="text-transform: none; border-radius: 5px; padding: 5px 20px"
          @click="acceptTicket()"
        ...
        <v-btn
          ...
          outlined
          v-if="
            $store.getters.checkPermission('linestop-tmpsending') ||
            isUserTicketOwner
          "
          elevation="0"
          style="text-transform: none; border-radius: 5px; padding: 5px 20px"
          ...
          <v-row class="mx-0 pa-0">
            ...
            <v-col class="py-0 pl-0 pr-4" cols="12">
              <div class="textField minHeight">
                <v-text-field
                  :disabled="ticket.status == 2 || ticket.status == 1"
                  outlined
                  v-model="description"
                  hide-details
                ></v-text-field>
