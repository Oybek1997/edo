  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('linestop.productionmodels') }}</span>
              ...
              <v-list class="dropdown-list pa-0">
                ...
                >
                  <v-list-item-title>
                    ...
                    {{ $t('linestop.add_production_model') }}
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('linestop.model_name') }}</label>
                <v-text-field
                  v-model="form.name"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/get/all-productmodels", {
    ...
    newItem() {
        this.dialogHeaderText = "linestop.add_production_model";
        this.form = {
          name: "",
        };
        this.dialog = true;
    ...
    save() {
        axios
          .post(
            this.$store.state.backend_url + "api/productmodel/saveupdate",
            this.form
          )
          .then(res => {
            this.getList();
