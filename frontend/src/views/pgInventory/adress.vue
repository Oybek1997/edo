  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("inventory.address") }}</span>
        ...
        <v-col class="ma-0 pa-0" xs="12">
          ...
          >
            ...
            <template v-slot:item.warehousename="{ item }">
              <span style="white-space: normal; max-width: 100px">
                {{
                  item.warehouse && item.warehouse.wh_name ? item.warehouse.wh_name : ""
                }}
              </span>
            </template>
            <template v-slot:item.warehousenumber="{ item }">
              <span style="white-space: normal; max-width: 100px">
                {{
                  item.warehouse && item.warehouse.wh_number ? item.warehouse.wh_number : ""
                }}
              </span>
            </template>
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: this.$t("inventory.warehouse_number"), value: "warehousenumber" },
        { text: this.$t("inventory.addressName"), value: "address_name" },

        // { text: this.$t("wh_number"), value: "wh_number" },

        // { text: this.$t("inventory.warehouse"), value: "warehousename" },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/pg_inventory/adress", {
          filter: this.filterForm,
          search: this.search,
          pagination: this.dataTableOptions,
        })
