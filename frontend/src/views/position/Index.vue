  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("position.index") }}</span>
          ...
          >
            ...
            <template v-slot:item.position_type_id="{ item }">
              <td style="max-width: 300px">
                <span>{{
                  item.position_type["name_" + $i18n.locale]
                }}</span>
              </td>
            </template>
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t("company_id") }}</label>
                <v-autocomplete
                  clearable
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t("positionType.index") }}</label>
                <v-autocomplete
                  clearable
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: this.$t("staff.position_id"), value: "position_type_id" },
        {
          text: this.$t("actions"),
          value: "actions",
          width: 50,
