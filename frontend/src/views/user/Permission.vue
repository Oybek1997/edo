  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('permission.index') }}</span>
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('permission.name') }}</label>
                <v-text-field
                  v-model="form.name"
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('permission.display_name') }}</label>
                <v-text-field
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('permission.description') }}</label>
                <v-text-field
...
export default {
  ...
  methods: {
    ...
    newItem() {
      if (this.$store.getters.checkPermission("user-create")) {
    ...
    editItem(item) {
      if (this.$store.getters.checkPermission("user-update")) {
