  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t("Диллер пользователи") }}</span>
          ...
          >
            ...
            <v-card>
              <v-list class="dropdown-list pa-0">
                <v-list-item
                  v-if="$store.getters.checkPermission('diller-create')"
      ...
      <v-row class="mx-0">
        ...
        >
          ...
          <template v-slot:[`item.type`]="{ item }">
            <span>{{
              item.type == "D"?$t("user.diller"):$t("user.company")
            }}</span>
          </template>
          <template v-slot:[`item.actions`]="{ item }">
            <v-btn
              v-if="$store.getters.checkPermission('diller-update')"
              class="px-0"
              color="blue"
            ...
            <v-btn
              v-if="$store.getters.checkPermission('diller-delete')"
              class="pl-0 pr-2"
              color="error"
              style="min-width: 25px" 
              small 
            ...
            <td :colspan="headers.length" class="ma-0 pa-0">
              <v-card class="ma-1 pa-1">
                ...
                <table style="border: 1px solid #aaa">
                  <tr>
                    <th>{{ $t("employee.tabel") }}</th>
                    <th>{{ $t("employee.email") }}</th>
                    <td>{{ $t("employee.department_id") }}</td>
                  </tr>
    ...
    <v-card class="mt-1 pa-3" style="border-radius: 1px">
        <span class="dialog-head_title pa-2 ma-2">{{ dialogHeaderText }}:</span>
        <v-divider class="mt-1 mb-4" style="border-color: #dce5ef"></v-divider>
        <v-card-text>
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="dialog-form ma-0 pa-0">
              <v-col cols="4">
                <v-autocomplete
                  clearable
                ...
                >
                  ...
                  <p class="txt_search2 mt-10 pa-0">{{
                    data.item.full_name
                  }}</p>
                  </template>
              ...
              <v-col cols="12" style="text-align: center">
                <h1 class="dialog-head_title">{{ $t("role.assign_role") }}</h1>
              </v-col>
                  ...
                  <template v-slot:default>
                    <thead>
                      <tr>
                        ...
                        <th class="dialog-head_title text-left font-weight-black" colspan="3">
                    ...
                    <tbody>
                      <tr>
                        <th colspan="3" class="pa-0 ma-0">
                          <v-row class="dialog-form ma-0 pa-0"><v-col>
                          <v-text-field
                      ...
                      >
                        ...
                        <td :title="item.display_name">
                          <p
                            class="txt_search2  text-truncate ma-0"
              ...
              <v-col cols="12" sm="6" class="pa-1">
                ...
                <v-divider></v-divider>
                <v-card-actions v-if="BPermission">
                  <v-spacer></v-spacer>
                  <v-btn
                  class="mr-3"
                  color="#3FCB5D"
              ...
              <v-col cols="12" style="text-align: center" v-if="BPermission">
                <h1 class="dialog-head_title ">{{ $t("role.assign_permission") }}</h1>
              </v-col>
    ...
    <v-dialog
      ...
      max-width="800px"
    >
    <v-card class="mt-3 pa-3" style="border-radius: 1px">
        ...
        <v-card-text class="pa-0 ma-0">
          ...
          <download-excel
            ...
            >
              ...
              <v-icon color="#fff" height="20">mdi-download</v-icon>
            </download-excel>
          </v-btn>
          <v-btn
            class
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        //.post(this.$store.state.backend_url + "api/users-diller-filter", {
        .post("https://b-edo.uzautomotors.com/api/users-diller-filter", {
