  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('role.index') }}</span>
          ...
          >
            ...
            <v-card>
              <v-list class="dropdown-list pa-0">
                <v-list-item
                  v-if="$store.getters.checkPermission('role-permission-create')"
        ...
        <v-col class="ma-0 pa-0" xs="12">
          ...
          >
            ...
            <template v-slot:item.actions="{ item }">
              <v-btn
                v-if="$store.getters.checkPermission('role-permission-update')"
                class="pl-0 pr-2"
                color="blue"
              ...
              <v-btn
                v-if="$store.getters.checkPermission('role-permission-delete')"
                class="pl-0 pr-2"
                color="error"
                style="min-width: 25px"
                small
    ...
    <v-dialog v-model="permissionDialog" persistent max-width="800px">
      <v-card class="pa-5">
        <v-card-title class="pa-0" primary-title>
          <span class="dialogTitle">{{ $t('role.dialogHeaderText') }}</span>
        </v-card-title>
      ...
      <v-card class="pa-5">
        ...
        <v-card-text>
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="ma-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('role.name') }}</label>
                <v-text-field
                  v-model="form.name"
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('role.display_name') }}</label>
                <v-text-field
              ...
              <v-col cols="12" class="pa-0 mb-3">
                <label class="labelTitle" for>{{ $t('role.description') }}</label>
                <v-text-field
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        v =>
          v.value != "actions" ||
          this.$store.getters.checkPermission("role-permission-update") ||
          this.$store.getters.checkPermission("role-permission-delete")
      );
    }
  },
  methods: {
