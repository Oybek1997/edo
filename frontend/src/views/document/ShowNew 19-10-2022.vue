      ...
      <v-card-title class="pa-0 pb-1" style="color: #000" color="black">
        ...
        <v-btn
          v-if="
            ...
            document.reaction_show &&
            document.action_type_id != 11 && 
            (![3,4,5].includes(document.status) || [11705, 8928, 8916,11888, 918].includes(user.employee_id) || document.action_type_id == 8 || ![70, 71, 75, 305, 214, 357, 136, 139, 155, 172, 373].includes(document.document_template_id))
          "
          small
          color="error"
          outlined
