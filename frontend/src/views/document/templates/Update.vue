<template>
            ...
            <v-row>
              <v-col cols="6">
                ...
                <v-autocomplete
                  ...
                  :items="department":rules="[v => !!v || $t('input.required')]"
                  hide-details="auto"
                  dense
                  outlined
                ></v-autocomplete>
              ...
              <v-col cols="12" sm="6">
                ...
                <v-autocomplete
                  ...
                  :items="documentType":rules="[v => !!v || $t('input.required')]"
                  hide-details="auto"
                  dense
                  outlined
                ></v-autocomplete>
              ...
              <v-col cols="12" sm="6">
                ...
                <v-autocomplete
                  ...
                  :items="signerGroup":rules="[v => !!v || $t('input.required')]"
                  hide-details="auto"
                  dense
                  outlined
                ></v-autocomplete>
            ...
            <v-row>
              <v-col cols="6">
                ...
                <v-text-field
                  ...
                  :rules="[v => !!v || $t('input.required')]"hide-details="auto"
                  dense
                  outlined
                ></v-text-field>
              </v-col>
 ...
 <v-col cols="6">
                ...
                <v-autocomplete
                  ...
                  :items="dataTypes":rules="[v => !!v || $t('input.required')]"
                  hide-details="auto"
                  dense
                  outlined
                ></v-autocomplete>
  ...
  methods: {
    saveStaff() {
      if (this.$refs.staffDialogform.validate())
        axios
          .post(this.$store.state.backend_url + "api/document_templates/updateDocumentDetailtAttribute", this.StaffForm)
          .then(res => {
            this.getList();
