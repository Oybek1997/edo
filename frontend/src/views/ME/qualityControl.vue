  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('Quality Control') }}</span>
          ...
          <v-form @keyup.native.enter="save" ref="dialogForm">
            <v-row class="mx-0 dialogForm">
              <v-col cols="12" class="pa-0 mb-3">
                ...
                <v-text-field
                  v-model="form.quality_control_name"
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: this.$t("Status nomi"), value: "quality_control_name" },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/me/quality-control", {
    ...
    save() {
      if (this.$refs.dialogForm.validate())
        axios
          .post(
            this.$store.state.backend_url + "api/me/quality-control/update",
