  ...
  <div class="fullHeight">
    ...
    >
      <v-card-title class="px-4 py-3">
        <span class="headerTitle mb-2">{{ $t('Status') }}</span>
...
export default {
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { text: this.$t("Status nomi"), value: "name" },
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      axios
        .post(this.$store.state.backend_url + "api/me/status", {
    ...
    save() {
      if (this.$refs.dialogForm.validate())
        axios
          .post(
            this.$store.state.backend_url + "api/me/status/update",
